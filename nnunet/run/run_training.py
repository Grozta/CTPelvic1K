...
if __name__ == "__main__":
    ...
    parser.add_argument("-u", "--unpack_data", required=False, default=1, type=int,
    ...
    if find_lr:
        ...
        trainer.validate(save_softmax=args.npz, validation_folder_name=val_folder, do_mirroring=False,
                         use_gaussian=True)
