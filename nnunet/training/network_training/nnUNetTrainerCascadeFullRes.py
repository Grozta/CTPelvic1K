...
from nnunet.training.dataloading.dataset_loading import DataLoader3D, unpack_dataset, DataLoader3D_oversampleJoint
...
class nnUNetTrainerCascadeFullRes(nnUNetTrainer):
    ...
    def process_plans(self, plans):
        ...
        self.modalities = self.num_input_channels
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if training:
            ...
            if self.refresh_lowrespred == True:
