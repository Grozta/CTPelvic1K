...
if __name__ == '__main__':
    ...
    eval_reslult_pkl_path = '/data/datasets/CTPelvic1K/folds/fold5_without4/test/img/Task6_CERVIX__CTPelvic1K__fold5_3dfullres_pred_hdc8/evaluation_sdf_35__2000_without4.pkl'
    ...
    for dataset in datasets:
        ...
        save_csv_path = eval_reslult_pkl_path.replace('_without4.pkl', '.pkl').replace('.pkl',
                                                                               '_{}_without4.csv'.format(dataset))
